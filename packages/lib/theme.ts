...
import theme_matrixLight from './themes/matrixLight';
import theme_matrixDark from './themes/matrixDark';
...
const themes: Record<number, Theme> = {
	...
	[Setting.THEME_MATRIX_LIGHT]: theme_matrixLight,
	[Setting.THEME_MATRIX_DARK]: theme_matrixDark,
};
